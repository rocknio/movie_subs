...
class MovieSubsDialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"射手网字幕下载器", pos=wx.DefaultPosition,
                           size=wx.Size(500, 500), style=wx.CLOSE_BOX | wx.DEFAULT_DIALOG_STYLE | wx.MINIMIZE_BOX,
                           name=u"main_dialog")
        ...
        self.m_filePicker1 = wx.FilePickerCtrl(self, wx.ID_ANY, u".", u"Select a Dir", u"*.*", wx.DefaultPosition,
                                               wx.Size(400, -1), wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE)
